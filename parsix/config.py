...
REGIONS = (
    ...
    "irkutsk", "kaliningrad", "kaluga", "kemerovo", "kirov", "kostroma",
    "kurgan", "kursk", "leningrad-reg", "lipetsk", "magadan", "moscow-reg",
    "murmansk", "nnov", "novgorod", "novosibirsk", "omsk", "orenburg", "orel",
    "penza", "pskov", "rostov", "ryazan", "samara", "saratov", "sakhalin",
